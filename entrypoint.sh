...
sed "s/<dependencies>/<dependencies><dependency><groupId>org.fenixedu<\/groupId><artifactId>$PROJECT_NAME<\/artifactId><version>$(echo $VERSION)<\/version><\/dependency>/g" -i pom.xml
